...
ERROR_FUNC_MAP_VAL=("collect_hang_oppo_log"
                    ...
                    "collect_gatekeeper_error_oppo_log"
                    )
...
function collect_gatekeeper_error_oppo_log()
{
    tmp_dir=$1
    #collect_atrace_log ${tmp_dir}
    collect_basic_log ${tmp_dir}
    phx_native_generate_keyfinfo ${tmp_dir}/ERROR_GATEKEEPER_ERROR_OPPO
}
